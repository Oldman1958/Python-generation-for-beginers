...
Программа должна вывести одну букву в верхнем регистре
или текст «Дальше букв нет» (без кавычек) в соответствии с условием задачи.
...
print(chr(ord(letter) + 1) if ord(letter) < ord('Я') else 'Дальше букв нет')